...
2. Vul alle verplichte velden in, waaronder het e-mailadres, wachtwoord, volledige naam en selecteer een organisatie uit de dropdownlijst. Het formulier laat pas inzenden toe wanneer een organisatie gekozen is.
...
3. Op de pagina zie je een lijst met openstaande aanvragen voor jouw organisatie, inclusief naam, e-mailadres, geselecteerde organisatie en datum van indienen.
...
6. De gebruiker ontvangt automatisch een account, wordt gekoppeld aan de gekozen begeleider en kan vanaf dat moment inloggen.
...
Het systeem maakt automatisch een gebruikersprofiel aan, koppelt de gebruiker aan de geselecteerde organisatie en voegt standaard welkomstberichten toe aan het chatlogboek.
