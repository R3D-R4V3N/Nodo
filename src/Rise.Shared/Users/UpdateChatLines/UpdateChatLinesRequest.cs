...
{
    public class UpdateChatLines
    {
        public List<string> DefaultChatLines { get; set; } = [];
    }

    public class UpdateChatLinesValidator : AbstractValidator<UpdateChatLines>
    {
        public UpdateChatLinesValidator(ValidatorRules rules)
        {
