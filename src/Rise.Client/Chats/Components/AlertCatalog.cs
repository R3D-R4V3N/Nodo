...
public static class AlertCatalog
{
    ...
    {
        new("Ongepast gedrag", MapPinIconSvg),
        new("Spam of fraude", SnowflakeIconSvg),
        new("Ander probleem", BandageIconSvg)
    };

    private const string MapPinIconSvg = """
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="h-6 w-6">
  <path d="M12 21.75a.75.75 0 0 1-.624-.334C9.273 18.45 6.75 14.047 6.75 10.5A5.25 5.25 0 0 1 12 5.25a5.25 5.25 0 0 1 5.25 5.25c0 3.547-2.523 7.95-4.626 10.916a.75.75 0 0 1-.624.334ZM12 12.75a2.25 2.25 0 1 0 0-4.5 2.25 2.25 0 0 0 0 4.5Z" />
</svg>
""";

    private const string SnowflakeIconSvg = """
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="h-6 w-6">
